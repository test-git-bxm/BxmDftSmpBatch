...
/**
 * @file         	bxm.jbk.smp.bean.MSmpDelimitedToDBInitBtch.java
...
@BxmBean("MSmpDelimitedToDBInitBtch")
@Scope("step")
@BxmCategory(logicalName = "FILE(DELIMITED) TO DB 샘플 초기화", description = "FILE(DELIMITED) TO DB 샘플 초기화")
public class MSmpDelimitedToDBInitBtch implements Tasklet{
