...
/**
 * @file         	bxm.jbk.smp.bean.MSmpDBToFixedInitBtch.java
...
@BxmBean("MSmpDBToFixedInitBtch")
@Scope("step")
@BxmCategory(logicalName = "DB TO FILE(FIXED) 샘플 초기화", description = "DB TO FILE(FIXED) 샘플 초기화")
public class MSmpDBToFixedInitBtch implements Tasklet {
