...
@BxmBean("MSmpFixedMultiTypeInitBtch")
@Scope("step")
@BxmCategory(logicalName = "FIXED MULTI TYPE 샘플 초기화", description = "FIXED MULTI TYPE 샘플 초기화")
public class MSmpFixedMultiTypeInitBtch implements Tasklet{
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) 
	{
		...
		File writeFixedFile = new File("/data1/prod/bxm400/dat/fixed_mtypefile2_" + oDate + ".txt");
		 ...
		 *  - 만일 에러를 발생하고 싶다면 ShbApplicationException을 throw 하면 된다.
		 */
