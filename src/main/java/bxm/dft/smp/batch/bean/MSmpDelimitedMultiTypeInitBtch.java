...
/**
 * @file         	bxm.jbk.smp.bean.MSmpDelimitedMultiTypeInitBtch.java
...
@BxmBean("MSmpDelimitedMultiTypeInitBtch")
@Scope("step")
@BxmCategory(logicalName = "DELIMITED MULTI TYPE 샘플", description = "DELIMITED MULTI TYPE 샘플")
public class MSmpDelimitedMultiTypeInitBtch implements Tasklet{
