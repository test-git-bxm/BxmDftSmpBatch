...
/**
 * @file         bxm.jbk.smp.bean.MSmpVariableToVariableInitBtch.java
...
@BxmBean("MSmpVariableToVariableInitBtch")
@Scope("step")
@BxmCategory(logicalName = "VARIABLE TO VARIABLE 샘플 초기화", description = "VARIABLE TO VARIABLE 샘플 초기화")
public class MSmpVariableToVariableInitBtch implements Tasklet {
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception 
	{
		 ...
		 */
		File writeFile = new File("/data1/prod/bxm400/dat/wvariable_file_"+ oDate + ".txt");
		if(writeFile.exists()) 
		{
			boolean isResult = writeFile.delete();
			if(!isResult)
			{
				logger.error("{} 파일을 Delete에 실패하였습니다.", writeFile);
			}
		}
