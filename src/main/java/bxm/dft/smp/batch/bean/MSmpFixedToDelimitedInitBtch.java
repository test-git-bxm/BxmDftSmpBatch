...
/**
 * @file         	bxm.jbk.smp.bean.MSmpFixedToDelimitedInitBtch.java
...
@BxmBean("MSmpFixedToDelimitedInitBtch")
@Scope("step")
@BxmCategory(logicalName = "FILE(FIXED) TO FILE(DELIMITED) 샘플 초기화", description = "FILE(FIXED) TO FILE(DELIMITED) 초기화")
public class MSmpFixedToDelimitedInitBtch implements Tasklet{
	...
	public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception 
	{
		 ...
		 */
		File writeFile = new File("/bxmdat/dat/delimited_file_"+ oDate + ".txt");
